...
unsafe void usb_server(streaming chanend c_FOC2CDC , streaming chanend sc_GUI2RX , int* unsafe angle){
        ...
        par{
                ...
                }
            {
                ...
                par{
                    ...
                    cdc_handler1(cdc[0] , c_FOC2CDC , sc_CDC2RX, c_ep_in , buffer_ptr);
